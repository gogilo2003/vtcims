...
import { iLink, iUsers } from '@/interfaces';
import { iFees, iStudents, iFeeTransactions, iTradeAreas } from '../interfaces/index';
...
const props = defineProps<{
    items: {
        ...
        to: number
        total: number
    } | iFees | iStudents | iFeeTransactions | iUsers | iTradeAreas
}>()
