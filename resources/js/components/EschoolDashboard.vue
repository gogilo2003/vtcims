            ...
            <div class="col-md-12 col-lg-4">
                <div class="card card-chart">
                    ...
                    <div class="card-footer">
                        ...
                        <a href="" class="btn btn-fab btn-round btn-success"><i class="material-icons">cloud_download</i></a>
                    </div>
                </div>
            </div>
        </div>
...
export default {
    mounted(){
        $.post(route('api-eschool-stats-totals')).then(function(response){
        ...
        $.post(route('api-eschool-stats-enrolment')).then(function (response) {
        ...
        $.post(route('api-eschool-stats-enrolment-status')).then(function (response) {
        ...
        $.post(route('api-eschool-stats-enrolment-yearly')).then(function (response) {
