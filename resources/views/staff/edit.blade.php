...
@section('content')
    <form method="post" action="{{route('admin-eschool-staff-edit-post')}}" role="form" accept-charset="UTF-8" enctype="multipart/form-data">
        <div class="row">
            <div class="col-md-3">
                <div class="fileinput fileinput-new text-center" data-provides="fileinput">
                    <div class="fileinput-new thumbnail img-raised">
                        <img src="{{ $staff->photo ? asset(config('admin.path_prefix').'/images/staff/'.$staff->photo) : asset(config('admin.path_prefix').'/vendor/admin/img/person_8x10.png') }}" alt="{{ $staff->name }}" class="img-fluid">
                    </div>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group{!! $errors->has('idno') ? ' has-error':'' !!}">
                            ...
                            <input type="text" class="form-control" id="idno" name="idno" value="{!! ((old('idno')) ? old('idno') : $staff->idno ) !!}">
                    ...
                    <div class="col-md-4">
                        <div class="form-group{!! $errors->has('pfno') ? ' has-error':'' !!}">
                            ...
                            <input type="text" class="form-control" id="pfno" name="pfno" value="{!! ((old('pfno')) ? old('pfno') : $staff->pfno ) !!}">
                    ...
                    <div class="col-md-4">
                        <div class="form-group{!! $errors->has('manno') ? ' has-error':'' !!}">
                            ...
                            <input type="text" class="form-control" id="manno" name="manno" value="{!! ((old('manno')) ? old('manno') : $staff->manno ) !!}">
                    ...
                    <div class="col-md-4">
                        <div class="form-group{!! $errors->has('surname') ? ' has-error':'' !!}">
                            ...
                            <input type="text" class="form-control" id="surname" name="surname" value="{!! ((old('surname')) ? old('surname') : $staff->surname ) !!}">
                    ...
                    <div class="col-md-4">
                        <div class="form-group{!! $errors->has('first_name') ? ' has-error':'' !!}">
                            ...
                            <input type="text" class="form-control" id="first_name" name="first_name" value="{!! ((old('first_name')) ? old('first_name') : $staff->first_name ) !!}">
                    ...
                    <div class="col-md-4">
                        <div class="form-group{!! $errors->has('middle_name') ? ' has-error':'' !!}">
                            ...
                            <input type="text" class="form-control" id="middle_name" name="middle_name" value="{!! ((old('middle_name')) ? old('middle_name') : $staff->middle_name ) !!}">
                    ...
                    <div class="col-md-4">
                        <div class="form-group{!! $errors->has('box_no') ? ' has-error':'' !!}">
                            ...
                            <input type="text" class="form-control" id="box_no" name="box_no" value="{!! ((old('box_no')) ? old('box_no') : $staff->box_no ) !!}">
                    ...
                    <div class="col-md-4">
                        <div class="form-group{!! $errors->has('post_code') ? ' has-error':'' !!}">
                            ...
                            <input type="text" class="form-control" id="post_code" name="post_code" value="{!! ((old('post_code')) ? old('post_code') : $staff->post_code ) !!}">
                    ...
                    <div class="col-md-4">
                        <div class="form-group{!! $errors->has('town') ? ' has-error':'' !!}">
                            ...
                            <input type="text" class="form-control" id="town" name="town" value="{!! ((old('town')) ? old('town') : $staff->town ) !!}">
                    ...
                    <div class="col-md-6">
                        <div class="form-group{!! $errors->has('email') ? ' has-error':'' !!}">
                            ...
                            <input type="text" class="form-control" id="email" name="email" value="{!! ((old('email')) ? old('email') : $staff->email ) !!}">
                    ...
                    <div class="col-md-6">
                        <div class="form-group{!! $errors->has('phone') ? ' has-error':'' !!}">
                            ...
                            <input type="text" class="form-control" id="phone" name="phone" value="{!! ((old('phone')) ? old('phone') : $staff->phone ) !!}">
                    ...
                    <div class="col-md-4">
                        <div class="form-group{!! $errors->has('gender') ? ' has-error':'' !!}">
                            ...
                            <select class="form-control selectpicker" id="gender" name="gender" data-style="btn btn-link" {!! ((old('gender')) ? ' value="' .old('gender').'"' : '' ) !!}>
                    ...
                    <div class="col-md-4">
                        <div class="form-group{!! $errors->has('employer') ? ' has-error':'' !!}">
                            ...
                            <select class="form-control selectpicker" id="employer" name="employer" data-style="btn btn-link">
                    ...
                    <div class="col-md-4">
                        <div class="form-group{!! $errors->has('staff_role_id') ? ' has-error':'' !!}">
                            ...
                            <select class="form-control selectpicker" id="staff_role_id" name="staff_role_id" data-style="btn btn-link">
                                @foreach (\Ogilo\Eschool\Models\StaffRole::all() as $role)
                                    <option value="{{ $role->id }}" {!! ((old('staff_role_id')===$role->id) ? 'selected' : ($staff->staff_role_id === $role->id ? 'selected' : '') ) !!}>{{ $role->name }}</option>
                                @endforeach
                            </select>
                            {!! $errors->has('staff_role_id') ? '<span class="text-danger">'.$errors->first('staff_role_id').'</span>' : '' !!}
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-md-9 offset-md-3">
                ...
                <button type="submit" class="btn btn-primary"><span class="material-icons">add</span> Update staff</button>
            </div>
        </div>
    </form>
@endsection
