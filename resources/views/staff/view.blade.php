...
@section('page_title')
    <i class="fa fa-list-alt"></i> {{ $staff->name }}
@endsection
...
<table class="table">
    <tr>
        <td rowspan="14" style="width: 20%; vertical-align: top;">
    ...
    <tr>
        ...
        <td><em>{{ $staff->post_code }}</em></td>
    </tr>
    <tr>
        <td class="text-right"><b>Town:</b></td>
        <td><em>{{ $staff->town }}</em></td>
    </tr>
    <tr>
        <td class="text-right"><b>Email:</b></td>
        <td><em>{{ $staff->email }}</em></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td><em>{{ $staff->employer }}</em></td>
    </tr>
    <tr>
        <td class="text-right"><b>Gender:</b></td>
        <td><em>{{ $staff->gender }}</em></td>
    </tr>
    <tr>
        <td class="text-right"><b>Last Updated:</b></td>
        <td><em>{!! $staff->updated_at->format('j\<\s\u\p\>S\<\/\s\u\p\>, F Y h:i:s A') !!}</em></td>
    </tr>
    <tr>
        <td colspan="3">
...
<hr>
<a href="{{ route('admin-eschool-staff-download',$staff->id) }}" class="btn btn-primary btn-round"><i class="material-icons">cloud_download</i> Download</a>
<a href="{{ route('admin-eschool-staff') }}" class="btn btn-primary btn-round"><i class="material-icons">list</i> Back to staff list</a>
@endsection