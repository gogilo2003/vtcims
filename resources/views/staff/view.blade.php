...
@section('content')
    ...
    <hr>
    <a href="{{ route('admin-eschool-staff-download', $staff->id) }}" class="btn btn-primary btn-round"><i
            class="material-icons">cloud_download</i> Download</a>
    <a href="{{ route('admin-eschool-staff') }}" class="btn btn-primary btn-round"><i class="material-icons">list</i> Back
        to staff list</a>
@endsection
