...
@section('content')
    <form method="post" action="{{route('admin-eschool-staff-add-post')}}" role="form" accept-charset="UTF-8" enctype="multipart/form-data">
        <div class="row">
            <div class="col-md-3">
                <div class="fileinput fileinput-new text-center" data-provides="fileinput">
                    <div class="fileinput-new thumbnail img-raised">
                        <img src="{{ asset(config('admin.path_prefix').'/vendor/admin/img/person_8x10.png') }}" alt="..." class="img-fluid">
                    </div>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group{!! $errors->has('idno') ? ' has-error':'' !!}">
                            ...
                            <input type="text" class="form-control" id="idno" name="idno" {!! ((old('idno'))
                                ? ' value="' .old('idno').'"' : '' ) !!}>
                    ...
                    <div class="col-md-4">
                        <div class="form-group{!! $errors->has('pfno') ? ' has-error':'' !!}">
                            ...
                            <input type="text" class="form-control" id="pfno" name="pfno" {!! ((old('pfno'))
                                ? ' value="' .old('pfno').'"' : '' ) !!}>
                    ...
                    <div class="col-md-4">
                        <div class="form-group{!! $errors->has('manno') ? ' has-error':'' !!}">
                            ...
                            <input type="text" class="form-control" id="manno" name="manno" {!! ((old('manno'))
                                ? ' value="' .old('manno').'"' : '' ) !!}>
                    ...
                    <div class="col-md-4">
                        <div class="form-group{!! $errors->has('surname') ? ' has-error':'' !!}">
                            ...
                            <input type="text" class="form-control" id="surname" name="surname" {!! ((old('surname'))
                                ? ' value="' .old('surname').'"' : '' ) !!}>
                            {!! $errors->has('surname') ? '<span
                    ...
                    <div class="col-md-4">
                        <div class="form-group{!! $errors->has('box_no') ? ' has-error':'' !!}">
                            ...
                            <input type="text" class="form-control" id="box_no" name="box_no" {!! ((old('box_no'))
                                ? ' value="' .old('box_no').'"' : '' ) !!}>
                    ...
                    <div class="col-md-4">
                        <div class="form-group{!! $errors->has('post_code') ? ' has-error':'' !!}">
                            ...
                            {!! $errors->has('post_code') ? '<span
                                class="text-danger">'.$errors->first('post_code').'</span>' : '' !!}
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group{!! $errors->has('town') ? ' has-error':'' !!}">
                            <label class="bmd-label-floating" for="town">Town</label>
                            <input type="text" class="form-control" id="town" name="town" {!! ((old('town'))
                                ? ' value="' .old('town').'"' : '' ) !!}>
                    ...
                    <div class="col-md-6">
                        <div class="form-group{!! $errors->has('phone') ? ' has-error':'' !!}">
                            ...
                            <input type="text" class="form-control" id="phone" name="phone" {!! ((old('phone'))
                                ? ' value="' .old('phone').'"' : '' ) !!}>
                    ...
                    <div class="col-md-4">
                        <div class="form-group{!! $errors->has('gender') ? ' has-error':'' !!}">
                            ...
                            <select class="form-control selectpicker" id="gender" name="gender" data-style="btn btn-link" {!! ((old('gender'))
                                ? ' value="' .old('gender').'"' : '' ) !!}>
                    ...
                    <div class="col-md-4">
                        <div class="form-group{!! $errors->has('employer') ? ' has-error':'' !!}">
                            ...
                            <select class="form-control selectpicker" id="employer" name="employer" data-style="btn btn-link" {!! ((old('employer'))
                                ? ' value="' .old('employer').'"' : '' ) !!}>
                    ...
                    <div class="col-md-4">
                        <div class="form-group{!! $errors->has('staff_role_id') ? ' has-error':'' !!}">
                            ...
                            <select class="form-control selectpicker" id="staff_role_id" name="staff_role_id" data-style="btn btn-link" {!!
                                ((old('staff_role_id')) ? ' value="' .old('staff_role_id').'"' : '' ) !!}>
            ...
            <div class="col-md-9 offset-md-3">
                ...
                <button type="submit" class="btn btn-primary"><span class="material-icons">add</span>  Save new staff</button>
            </div>
        </div>
    </form>
@endsection