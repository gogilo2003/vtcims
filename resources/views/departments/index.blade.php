    ...
    <div class="row">
        <div class="col-md-4">
            <div class="card">
                <div class="card-body">
                    <form method="post"
                        action="{{ $errors->count() && old('id') ? route('admin-eschool-departments-edit-post') : route('admin-eschool-departments-add-post') }}"
                        role="form" accept-charset="UTF-8" enctype="multipart/form-data" id="departmentDataForm">
                        ...
                        <div class="form-group{!! $errors->has('hod') ? ' has-error' : '' !!}">
                            ...
                            <select data-live-search="true" data-style="btn btn-link" class="form-control selectpicker"
                                id="hod" name="hod"{!! old('hod') ? ' value="' . old('hod') . '"' : '' !!}>
                            ...
                            <tbody>
                                @foreach ($departments as $department)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="javascript:" data-department="{{ $department->toJson() }}"
                                                class="btn btn-fab btn-primary btn-round btn-sm editDepartment"><i
