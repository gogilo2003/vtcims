...
@section('content')
    <a href="{{ route('admin-eschool-examinations-marks', $examination->id) }}" class="btn btn-round btn-primary"><span
            class="material-icons">content_paste</span> Marks Entry</a>
    <a href="{{ route('admin-eschool-examinations-download', $examination->id) }}" class="btn btn-round btn-primary"><span
            class="material-icons">cloud_download</span> Download Marklist</a>
