            ...
            <div class="card">
                <div class="card-body">
                    <form id="courseForm" method="post"
                        action="{{ $errors->count() && old('id') ? route('admin-eschool-courses-edit-post') : route('admin-eschool-courses-add-post') }}"
                            ...
                            <tbody>
                                @foreach ($courses as $course)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="JavaScript:"
                                                class="btn btn-fab btn-primary btn-sm btn-round editCourseButton"
                                                data-course="{{ $course->toJson() }}"><i
