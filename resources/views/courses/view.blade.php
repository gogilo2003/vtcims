...
<table class="table table-striped">
    ...
    <tr>
    	...
    	<td>
    		<a href="{{ route('admin-eschool-departments-view',$course->department->id) }}"> {{ $course->department->name }}</a>
    	</td>
    </tr>
    <tr>
    	<td class="text-uppercase">
    ...
    <tr>
    	...
    	<td>
    		@foreach ($course->subjects as $subject)
    			<a href="{{ route('admin-eschool-subjects-view',$subject->id) }}" class="btn btn-round btn-sm btn-outline-primary">{{ $subject->name }}</a>
    		@endforeach
    	</td>
    </tr>
    <tr>
