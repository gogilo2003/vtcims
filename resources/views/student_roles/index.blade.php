...
@section('content')
    <div class="row">
        <div class="col-md-4">
            <div class="card">
                <div class="card-body">
                    <form id="student_roleForm" method="post"
                        action="{{ $errors->count() && old('id') ? route('admin-eschool-student_roles-edit-post') : route('admin-eschool-student_roles-add-post') }}"
                        ...
                        <button type="submit" class="btn btn-primary btn-round"><span class="material-icons">save</span>
                            Save</button>
                        <a href="JavaScript:" id="cancelStudentRoleEdit" class="btn btn-danger btn-round"
            ...
            <div class="card">
                <div class="card-body">
                    <div class="table-responsive">
                            ...
                            <tbody>
                                @foreach ($student_roles as $student_role)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="JavaScript:"
                                                class="btn btn-primary btn-fab btn-round btn-sm editStudentRoleButton"
                                                data-student_role="{{ $student_role->toJson() }}"><i
                                                    class="material-icons">edit</i></a>
                                            <a href="JavaScript:"
                                                class="btn btn-fab btn-round btn-danger btn-sm deleteStudentRoleButton"
                                                data-id="{{ $student_role->id }}" data-name="{{ $student_role->name }}"><i
                        ...
                        <form id="deleteStudentRoleForm" method="post"
                            action="{{ route('admin-eschool-student_roles-delete') }}" role="form" accept-charset="UTF-8"
