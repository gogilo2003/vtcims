<!-- Add/Edit Dialog -->
<div class="modal fade" data-backdrop="static" id="studentDialog" tabindex="-1" role="dialog" aria-labelledby="StduentDetails">
	<div class="modal-dialog modal-lg modal-dialog-centered" role="document">
		<div class="modal-content">
			<div class="card">
				<form id="studentDetailsForm" method="post" action="{{ ($errors->count() && old('id')) ? route('admin-eschool-students-add-post') : route('admin-eschool-students-add-post') }}" role="form" accept-charset="UTF-8" enctype="multipart/form-data">
						...
						<div class="row">
							<div class="col-md-12">
								<div class="form-group{!! $errors->has('id') ? ' has-error':'' !!}">
									<input type="hidden" class="form-control" id="studentId" name="id"{!! ((old('id')) ? ' value="'.old('id').'"' : '') !!}>
							...
							<div class="col-md-4">
								<div class="form-group{!! $errors->has('surname') ? ' has-error':'' !!}">
									...
									<input type="text" class="form-control" id="surname" name="surname"{!! ((old('surname')) ? ' value="'.old('surname').'"' : '') !!}>
							...
							<div class="col-md-4">
								<div class="form-group{!! $errors->has('middle_name') ? ' has-error':'' !!}">
									...
									<input type="text" class="form-control" id="middle_name" name="middle_name"{!! ((old('middle_name')) ? ' value="'.old('middle_name').'"' : '') !!}>
							...
							<div class="col-md-4">
								<div class="form-group{!! $errors->has('first_name') ? ' has-error':'' !!}">
									...
									<input type="text" class="form-control" id="first_name" name="first_name"{!! ((old('first_name')) ? ' value="'.old('first_name').'"' : '') !!}>
							...
							<div class="col-md-4">
								<div class="form-group{!! $errors->has('phone') ? ' has-error':'' !!}">
									...
									<input type="text" class="form-control" id="phone" name="phone"{!! ((old('phone')) ? ' value="'.old('phone').'"' : '') !!}>
							...
							<div class="col-md-8">
								<div class="form-group{!! $errors->has('email') ? ' has-error':'' !!}">
									...
									<input type="text" class="form-control" id="email" name="email"{!! ((old('email')) ? ' value="'.old('email').'"' : '') !!}>
							...
							<div class="col-md-4">
								<div class="form-group{!! $errors->has('box_no') ? ' has-error':'' !!}">
									...
									<input type="text" class="form-control" id="box_no" name="box_no"{!! ((old('box_no')) ? ' value="'.old('box_no').'"' : '') !!}>
							...
							<div class="col-md-4">
								<div class="form-group{!! $errors->has('post_code') ? ' has-error':'' !!}">
									...
									<input type="text" class="form-control" id="post_code" name="post_code"{!! ((old('post_code')) ? ' value="'.old('post_code').'"' : '') !!}>
							...
							<div class="col-md-4">
								<div class="form-group{!! $errors->has('town') ? ' has-error':'' !!}">
									...
									<input type="text" class="form-control" id="town" name="town"{!! ((old('town')) ? ' value="'.old('town').'"' : '') !!}>
							...
							<div class="col-md-12">
								<div class="form-group{!! $errors->has('physical_address') ? ' has-error':'' !!}">
									...
									{!! $errors->has('physical_address') ? '<span class="text-danger">'.$errors->first('physical_address').'</span>' : '' !!}
								</div>
							</div>
							<div class="col-md-4">
								<div class="form-group bmd-form-group is-filled is-focused {!! $errors->has('date_of_birth') ? ' has-error':'' !!}">
									...
									<input type="text" class="form-control datepicker" id="date_of_birth" name="date_of_birth"{!! ((old('date_of_birth')) ? ' value="'.old('date_of_birth').'"' : '') !!}>
									{!! $errors->has('date_of_birth') ? '<span class="text-danger">'.$errors->first('date_of_birth').'</span>' : '' !!}
								</div>
							</div>
							<div class="col-md-4">
								<div class="form-group{!! $errors->has('birth_certificate_no') ? ' has-error':'' !!}">
									<label class="bmd-label-floating" for="birth_certificate_no">Birth Certificate No</label>
									<input type="text" class="form-control" id="birth_certificate_no" name="birth_certificate_no"{!! ((old('birth_certificate_no')) ? ' value="'.old('birth_certificate_no').'"' : '') !!}>
									{!! $errors->has('birth_certificate_no') ? '<span class="text-danger">'.$errors->first('birth_certificate_no').'</span>' : '' !!}
								</div>
							</div>
							<div class="col-md-4">
								<div class="form-group{!! $errors->has('idno') ? ' has-error':'' !!}">
									<label class="bmd-label-floating" for="idno">IDNo</label>
									<input type="text" class="form-control" id="idno" name="idno"{!! ((old('idno')) ? ' value="'.old('idno').'"' : '') !!}>
							...
							<div class="col-md-4">
								<div class="form-group bmd-form-group is-filled is-focused{!! $errors->has('date_of_admission') ? ' has-error':'' !!}">
									<label class="bmd-label-floating" for="date_of_admission">Date of Admission</label>
									<input type="text" class="form-control datepicker" id="date_of_admission" name="date_of_admission"{!! ((old('date_of_admission')) ? ' value="'.old('date_of_admission').'"' : '') !!}>
							...
							<div class="col-md-4">
								<div class="form-group bmd-form-group is-filled is-focused{!! $errors->has('intake') ? ' has-error':'' !!}">
									...
									<select data-live-search="true" class="form-control selectpicker" data-style="btn btn-link" id="intake" name="intake" {!! ((old('intake')) ? old('intake') : '') !!}>
							...
							<div class="col-md-4">
								<div class="form-group bmd-form-group is-filled is-focused{!! $errors->has('program') ? ' has-error':'' !!}">
									...
									<select data-live-search="true" class="form-control selectpicker" data-style="btn btn-link" id="program" name="program"{!! ((old('program')) ? ' value="'.old('program').'"' : '') !!}>
							...
							<div class="col-md-4">
								<div class="form-group bmd-form-group is-filled is-focused{!! $errors->has('sponsor') ? ' has-error':'' !!}">
									...
									<select data-live-search="true" class="form-control selectpicker" data-style="btn btn-link" id="sponsor" name="sponsor"{!! ((old('sponsor')) ? ' value="'.old('sponsor').'"' : '') !!}>
							...
							<div class="col-md-4">
								<div class="form-group bmd-form-group is-filled is-focused{!! $errors->has('student_role') ? ' has-error':'' !!}">
									...
									<select data-live-search="true" class="form-control selectpicker" data-style="btn btn-link" id="student_role" name="student_role"{!! ((old('student_role')) ? ' value="'.old('student_role').'"' : '') !!}>
										@foreach (\Ogilo\Eschool\Models\StudentRole::all() as $student_role)
											<option value="{{ $student_role->id }}">{{ $student_role->name }}</option>
										@endforeach
									</select>
									{!! $errors->has('student_role') ? '<span class="text-danger">'.$errors->first('student_role').'</span>' : '' !!}
								</div>
							</div>
							<div class="col-md-4">
								<div class="form-group bmd-form-group is-filled is-focused{!! $errors->has('status') ? ' has-error':'' !!}">
									...
									<select data-live-search="true" class="form-control selectpicker" data-style="btn btn-link" id="status" name="status"{!! ((old('status')) ? ' value="'.old('status').'"' : '') !!}>
					...
					<div class="card-footer">
						...
						<button type="reset" id="cancelStudedntButton" class="btn btn-danger btn-round"><i class="material-icons">cancel</i> Cancel</button>
					</div>
				</form>
			</div>
		</div>
