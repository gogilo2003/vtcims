...
@section('content')
    <table class="table table-no-border">
    	<tr>
    		<td width="20%" style="vertical-align: top;">
    			<img src="{{ file_exists(public_path('images/students/'.$student->photo)) && $student->photo ? asset(config('admin.path_prefix').'/images/students/'.$student->photo) : asset(config('admin.path_prefix').'/vendor/admin/img/person_8x10.png') }}" alt="" class="img-fluid">
    		</td>
    		<td width="80%">
        ...
        <tbody>
            @foreach ($student->leaveouts as $leaveout)
                <tr>
                    ...
                    <td>
                        <a href="{{ route('admin-eschool-students-leaveout',$leaveout->id) }}" class="btn btn-primary btn-fab btn-round btn-sm"><i class="material-icons">cloud_download</i></a>
                    </td>
                </tr>
            @endforeach
        </tbody>
	...
	<div class="text-center">
		<a href="{{ route('admin-eschool-students-download',$student->id) }}" class="btn btn-round btn-primary"><i class="material-icons">cloud_download</i> Download</a>
		<a href="{{ route('admin-eschool-students') }}" class="btn btn-round btn-primary"><i class="material-icons">list</i> Back to students list</a>
	</div>
@endsection
