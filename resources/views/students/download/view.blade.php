    ...
    <table class="table table-no-border">
        <tr>
            <td width="15%" style="vertical-align: top;">
                <img src="{{ file_exists('images/students/' . $student->photo) && $student->photo ? asset(config('admin.path_prefix') . '/images/students/' . $student->photo) : asset(config('admin.path_prefix') . '/vendor/admin/img/person_8x10.png') }}"
                    alt="" class="img-fluid">
            </td>
            <td width="85%">
