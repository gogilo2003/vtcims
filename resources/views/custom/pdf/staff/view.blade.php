...
@section('content')
    <table class="w-full">
        ...
        <tr>
            <td class="border border-gray-800 text-right" style="max-width: 20%"><b>Name:</b></td>
            <td><em>{{ $staff->name }}</em></td>
        </tr>
        <tr>
            <td class="border border-gray-800 text-right"><b>Position:</b></td>
            <td><em>{{ $staff->role->name }}</em></td>
        </tr>
        <tr>
            <td class="border border-gray-800 text-right"><b>Idno:</b></td>
            <td><em>{{ $staff->idno }}</em></td>
        </tr>
        <tr>
            <td class="border border-gray-800 text-right"><b>PF/No:</b></td>
            <td><em>{{ $staff->pfno }}</em></td>
        </tr>
        <tr>
            <td class="border border-gray-800 text-right"><b>Manno:</b></td>
            <td><em>{{ $staff->manno }}</em></td>
        </tr>
        <tr>
            <td class="border border-gray-800 text-right"><b>Box No:</b></td>
            <td><em>{{ $staff->box_no }}</em></td>
        </tr>
        <tr>
            <td class="border border-gray-800 text-right"><b>Post Code:</b></td>
            <td colspan="2"><em>{{ $staff->post_code }}</em></td>
        </tr>
        <tr>
            <td class="border border-gray-800 text-right"><b>Town:</b></td>
            <td colspan="2"><em>{{ $staff->town }}</em></td>
        </tr>
        <tr>
            <td class="border border-gray-800 text-right"><b>Email:</b></td>
            <td colspan="2"><em>{{ $staff->email }}</em></td>
        </tr>
        <tr>
            <td class="border border-gray-800 text-right"><b>Phone No:</b></td>
            <td colspan="2"><em>{{ $staff->phone }}</em></td>
        </tr>
        <tr>
            <td class="border border-gray-800 text-right"><b>Employer:</b></td>
            <td colspan="2"><em>{{ $staff->employer }}</em></td>
        </tr>
        <tr>
            <td class="border border-gray-800 text-right"><b>Gender:</b></td>
            <td colspan="2"><em>{{ $staff->gender }}</em></td>
        </tr>
        <tr>
            <td class="border border-gray-800 text-right"><b>Last Updated:</b></td>
