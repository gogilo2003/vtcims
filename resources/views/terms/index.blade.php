            ...
            <div class="card">
                <div class="card-body">
                    <form id="termForm" method="post"
                        action="{{ isset($errors) && old('id') ? route('admin-eschool-terms-edit-post') : route('admin-eschool-terms-add-post') }}"
                        role="form" accept-charset="UTF-8" enctype="multipart/form-data">
                        <div class="form-group{!! $errors->has('id') ? ' has-error' : '' !!}">
                            <input type="hidden" id="termId" name="id"
                                placeholder="Enter value"{!! old('id') ? ' value="' . old('id') . '"' : '' !!}>
                        ...
                        <div class="form-group{!! $errors->has('start_date') ? ' has-error' : '' !!}">
                            ...
                            <input type="text" class="form-control datepicker" id="start_date"
                                name="start_date"{!! old('start_date') ? ' value="' . old('start_date') . '"' : '' !!}>
                        ...
                        <div class="form-group{!! $errors->has('end_date') ? ' has-error' : '' !!}">
                            ...
                            <input type="text" class="form-control datepicker" id="end_date"
                                name="end_date"{!! old('end_date') ? ' value="' . old('end_date') . '"' : '' !!}>
                        ...
                        <button type="submit" class="btn btn-primary btn-round"><span class="material-icons">save</span>
                            Save</button>
                        <a href="JavaScript:" class="btn btn-round btn-danger" id="cancelEditButton"
                        ...
                        <tbody>
                            @foreach ($terms as $term)
                                <tr>
                                    ...
                                    <td>
                                        <a href="JavaScript:"
                                            class="btn btn-fab btn-round btn-sm btn-primary editTermButton"
                                            data-term="{{ $term->toJson() }}"><i class="material-icons">edit</i></a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
